...
#zmienne
pogoda = np.arange(-10,40,1)
pompadzialanie = np.arange(-0.001,0.0003,0.001)
#funkcje przynaleznosci
pog_snieg = fuzz.trimf(pogoda,[-10,-5,0])
pog_deszcz = fuzz.trimf(pogoda,[0,10,25])
pog_slonce = fuzz.trimf(pogoda,[25,40,40])
...
ax2.set_xlabel("Działanie pompy")
